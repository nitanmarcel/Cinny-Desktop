...
async function getOptions(rawOptions) {
    ...
    const options = {
        packager: {
            ...
            arch: (_a = rawOptions.arch) !== null && _a !== void 0 ? _a : inferOs_1.inferArch(),
    ...
    if (rawOptions.globalShortcuts) {
        ...
        const globalShortcuts = parseUtils_1.parseJson(fs.readFileSync(rawOptions.globalShortcuts).toString());
